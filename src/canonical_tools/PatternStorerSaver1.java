...
public class PatternStorerSaver1 {
    ...
    public static void save_pattern() {
            ...
            if(InputParameters.outputFilePath != null) {
                try {
                pps_player.saveMidi(music_output, InputParameters.outputFilePath);
                }
                ...
                try {
                    pps_player.saveMidi(music_output, new File(InputParameters.getTempo() + "-" + dateString + ".mid"));
                }
